...
namespace gve
{
	...
	{	
		...
		auto bindingDescriptions = GveModel::Vertex::getBindingDescriptions();
		auto attributeDescriptions = GveModel::Vertex::getAttributeDescriptions();
	...
	void GvePipeline::bind(VkCommandBuffer commandBuffer)
	{
		vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
	}


	void GvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
	{
